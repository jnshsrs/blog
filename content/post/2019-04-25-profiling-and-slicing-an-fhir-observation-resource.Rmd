...
Because blood pressure has two components, the systolic and diastolic part, this profile furthermore uses the `component` element of the observation resource.
The profile defines two components, one for the systolic and one for the diastolic blood pressure using LOINC codes again.
The process of creating instances of resource elements in the profiling process is called slicing.
