...
You can follow this example with this [python script](https://github.com/jnshsrs/blog/code/post-resources "Posting Resources to HAPI Server").
...
A simple query returns the patient that was uploaded for this usecase:

<http://hapi.fhir.org/baseR4/Patient/1943704>

Next, we request all conditions on the server

<http://hapi.fhir.org/baseR4/Conditions>
...
However, in many cases, we do want all Condition resources of a specifc encounter class, e.g. emergency.
