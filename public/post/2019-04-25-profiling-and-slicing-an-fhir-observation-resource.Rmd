...
As I was profiling a FHIR observation resource with Forge, I copied a profiling strategy from the FHIR core specification.
This profile was about the vital sign *blood pressure* which is represented by the systolic and the diastolic blood pressure.
Following this logic, the profile captures blood pressure using two distinct values. 
In order to encode both values, the core specification uses the componente element of the observation resource which is sliced.
